...
Route::prefix('admin')->group(function () {
    ...
    Route::post('/add-buyer', [AdminController::class, 'storeBuyer'])->name('admin.add-buyer.store');
    Route::get('/edit-buyer/{buyer}', [AdminController::class, 'editBuyer'])->name('admin.edit-buyer');
    Route::put('/edit-buyer/{buyer}', [AdminController::class, 'updateBuyer'])->name('admin.update-buyer');
    Route::delete('/delete-buyer/{buyer}', [AdminController::class, 'destroyBuyer'])->name('admin.delete-buyer');
    Route::patch('/buyers/{buyer}/status', [AdminController::class, 'updateBuyerStatus'])->name('admin.buyers.status');
    ...
    Route::post('/add-seller', [AdminController::class, 'storeSeller'])->name('admin.add-seller.store');
    Route::get('/edit-seller/{seller}', [AdminController::class, 'editSeller'])->name('admin.edit-seller');
    Route::put('/edit-seller/{seller}', [AdminController::class, 'updateSeller'])->name('admin.update-seller');
    ...
    Route::post('/account-settings', [AdminController::class, 'updateAccountSettings'])->name('admin.account-settings.update');
    ...
    Route::get('/bank-transfer/data', [AdminController::class, 'bankTransferData'])->name('admin.bank-transfer.data');
